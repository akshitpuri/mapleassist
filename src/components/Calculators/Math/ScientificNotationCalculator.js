...
export default function ScientificNotationCalculator() {
  ...
  return (
    <CalculatorLayout title="🔬 Scientific Notation Calculator">
      <Helmet>
        <title>Scientific Notation Calculator – MapleAssist</title>
        ...
        <meta name="keywords" content="scientific notation calculator, e notation, standard form, mapleassist math tool" />
      </Helmet>
