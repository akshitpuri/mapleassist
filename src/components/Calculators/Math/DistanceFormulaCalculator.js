...
export default function DistanceFormulaCalculator() {
  ...
  return (
    <CalculatorLayout title="📏 Distance Formula Calculator">
      <Helmet>
        <title>Distance Formula Calculator – MapleAssist</title>
        ...
        <meta name="keywords" content="distance formula calculator, 2D distance, 3D distance, coordinate geometry, mapleassist math tool" />
      </Helmet>
