...
export default function LoanCalculator() {
  ...
  const calculateLoan = () => {
    ...
    setMonthlyPayment(`Monthly Payment: $${payment.toFixed(2)}`);
  };
  ...
  return (
    <CalculatorLayout title="🏦 Loan Calculator">
      ...
      <p style={{
        ...
        Enter loan amount, annual interest rate, and repayment term in years to estimate your monthly payment. Useful for personal, home, or student loans.
      </p>
